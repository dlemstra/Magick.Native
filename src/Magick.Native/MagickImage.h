...
MAGICK_NATIVE_EXPORT void MagickImage_ImportIndexedPixels(Image *, const size_t, const size_t, const PixelInfo *, const size_t, const size_t, const void *, ExceptionInfo **);
...
MAGICK_NATIVE_EXPORT Image *MagickImage_Splice(const Image *, const char *, const size_t, ExceptionInfo **);
