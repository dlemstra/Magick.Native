...
mkdir __build
cd __build
$CMAKE_COMMAND .. -DCMAKE_INSTALL_PREFIX=/usr/local -DBUILD_SHARED_LIBS=false -DBROTLI_DISABLE_TESTS=true -DCMAKE_BUILD_TYPE=Release -DCMAKE_C_FLAGS="$FLAGS -DBROTLI_EXTERNAL_DICTIONARY_DATA"
$MAKE install
